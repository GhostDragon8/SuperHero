...
namespace SuperHero.Controllers
{
    public class ProfilesController : Controller
    {
        ...
        {
            var profile = db.Profile.Include(p => p.Member);
        ...
        public ActionResult Create([Bind(Include = "ProfID,Bio,MemID")] Profile profile)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ProfID,Bio,MemID")] Profile profile)
        {
            if (ModelState.IsValid)
            {
